...
public class Sample1Aspect {
    ...
    @AfterThrowing(pointcut = "execution(* bg.softuni.aop.IncredibleMachine.boom())", throwing = "error")
    ...
    public void beforeEachMethod(JoinPoint joinPoint) {
        LOGGER.info("Before calling method {} with arguments {}", joinPoint.getSignature(),
