...
public class FamilyTree {
    ...
    public String toString() {
        ...
        familyTree.append(this.mainPerson).append(System.lineSeparator())
                ...
                .append(this.parents.size() == 0 ? ""
                        : String.format("%s%s", this.parents.stream()
                        .map(Person::toString).collect(Collectors.joining(System.lineSeparator())), System.lineSeparator()))
                .append("Children:").append(System.lineSeparator())
                .append(String.format("%s", this.children.stream().
