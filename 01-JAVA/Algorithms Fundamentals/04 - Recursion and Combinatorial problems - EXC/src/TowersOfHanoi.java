...
public class TowersOfHanoi {
    ...
    public static void main(String[] args) throws IOException {
        ...
        int disk = Integer.parseInt(reader.readLine()); //number of discs  n
    ...
    private static void solve(int disk, Deque<Integer> source, Deque<Integer> destination, Deque<Integer> spare) {
        if (disk == 1) {
            ...
            solve(1, source, destination, spare); //правилния входен ред
    ...
    private static Object formatRod(Deque<Integer> stack) {
        return stack.stream()
