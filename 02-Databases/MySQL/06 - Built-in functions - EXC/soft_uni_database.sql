...
SELECT LOCATE('@', 'chavdar.mitkov@softu@ni.bg', 16);

SELECT YEAR('1997-05-08');
...
SELECT * FROM `towns`
WHERE LOWER(`name`) LIKE 'k%' OR LOWER(`name`) LIKE 'm%' OR LOWER(`name`) LIKE 'b%' OR LOWER(`name`) LIKE 'e%'
ORDER BY `name`;
